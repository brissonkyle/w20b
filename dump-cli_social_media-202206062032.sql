...
--
-- Host: 34.168.131.208    Database: cli_social_media
-- ------------------------------------------------------
-- Server version	5.5.5-10.7.4-MariaDB-1:10.7.4+maria~bullseye
...
CREATE TABLE `exploits` (
  `exploit_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `content` text NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`exploit_id`),
  KEY `exploits_FK` (`user_id`),
  CONSTRAINT `exploits_FK` FOREIGN KEY (`user_id`) REFERENCES `hacker` (`id`)
...
INSERT INTO `hacker` VALUES (1,'Susan','1'),(2,'Colette','3'),(3,'Edgar','4'),(4,'Addison','3'),(5,'Joe','1');
...
-- Dump completed on 2022-06-06 20:32:20
